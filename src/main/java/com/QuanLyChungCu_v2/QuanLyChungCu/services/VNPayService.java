...
class VNPayConfig {
    ...
    public static String vnp_TmnCode = "BC9UEVKM";
    public static String vnp_HashSecret = "CRAUR49SJKDETKZPGR06DJ7KI0K05WRA";
    ...
    public static String getRandomNumber(int len) {
        ...
        String chars = "0123456789acbdefghiklmnopq";
...
public class VNPayService {
    ...
    public String CreateUrlPayment(double total, String orderInfor, String urlReturn){
        ...
        System.out.println("Link Payment: " + VNPayConfig.vnp_PayUrl + queryUrl);
